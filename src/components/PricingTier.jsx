  ...
  return (
    ...
    >
      <div className="relative h-full p-6 flex flex-col">
        ...
        <button className="bg-indigo-500 py-4 w-full text-zinc-50 rounded-full text-lg clash-display cursor-pointer hover:bg-indigo-400/10 hover:text-indigo-300 hover:-translate-y-1 transition2 ">
          Start Trading
        </button>
      </div>
    </CardSpotlight>
