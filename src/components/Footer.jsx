      ...
      <div className="container mx-auto px-4">
        <div className="bg-[#0A0A0A]/80  border border-white/10 rounded-xl p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <button variant="ghost" size="icon">
                  <BsInstagram className="w-6 h-6 hover:text-indigo-400 hover:-translate-y-1 transition-all ease-out duration-300" />
                </button>
                <button variant="ghost" size="icon">
                  <FaFacebook className="w-6 h-6 hover:text-indigo-400 hover:-translate-y-1 transition-all ease-out duration-300" />
                </button>
                <button variant="ghost" size="icon">
                  <BsLinkedin className="w-6 h-6 hover:text-indigo-400 hover:-translate-y-1 transition-all ease-out duration-300" />
                </button>
              </div>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-white/10">
            ...
            &copy; {new Date().getFullYear()} Forex Trade. All rights reserved{" "}
            | Made by{" "}
            <a
              href="https://github.com/rizzwannndev"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block transition-all duration-300 ease-out hover:translate-x-1 hover:text-indigo-300"
            >
              Rizwan Waseem
            </a>
          </p>
